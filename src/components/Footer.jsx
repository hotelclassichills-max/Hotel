...
import { siteConfig, telLink, mailLink, reservationsMailLink } from '../data/siteConfig'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-ivory/70">
              ...
              <li className="flex items-start gap-2.5">
                <Icon name="mail" className="w-4 h-4 mt-0.5 flex-shrink-0 text-saffron" />
                <a href={reservationsMailLink()} className="hover:text-saffron transition-colors break-all">
