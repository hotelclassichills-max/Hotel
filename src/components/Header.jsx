...
export default function Header() {
  ...
  return (
    ...
    >
      {/* Top info bar */}
      <div
        className={`hidden lg:block border-b transition-all duration-500 ease-refined overflow-hidden ${
      ...
      <div className="container-hotel">
        ...
        >
          ...
          {/* Desktop nav */}
          <nav className={`hidden lg:flex items-center gap-8 font-sans text-sm tracking-wide ${solid ? 'text-charcoal' : 'text-ivory'}`}>
          ...
          <button
            ...
            className={`lg:hidden p-2 -mr-2 ${solid ? 'text-forest-800' : 'text-ivory'}`}
          >
      ...
      {/* Mobile menu panel */}
      <div
        className={`lg:hidden fixed inset-x-0 top-0 bottom-0 bg-ivory-soft z-40 transition-transform duration-500 ease-refined ${
