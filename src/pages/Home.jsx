...
// Hero slider images. The photo previously used as the static hero
// (exteriorHillside) is intentionally excluded from the slider — it's
// still used for SEO/social-preview metadata above, just not shown here.
...
const heroSlides = [exteriorEntrance, balconyView, forestSunset, dining1]
    ...
    <>
      ...
      <section className="relative section-pad bg-forest-800 text-ivory overflow-hidden">
        ...
        <div className="container-hotel relative grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <Reveal>
            <img
              src={exteriorBalconyDusk}
              alt="Mountain view from a Hotel Classic Hills balcony at dusk"
      ...
      <section className="relative section-pad">
        <img src={exteriorNightAerial} alt="" className="absolute inset-0 w-full h-full object-cover" loading="lazy" />
